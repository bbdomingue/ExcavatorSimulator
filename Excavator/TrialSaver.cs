...
namespace Excavator
{
    public class TrialSaver
    {
        ...
        public unsafe struct File1_DataType
        {
            ...
            [FieldOffset(a1)] public fixed float Q[4];         const int a2 = a1 + sizeof(float) * 4;
            [FieldOffset(a2)] public fixed float QD[4];        const int a3 = a2 + sizeof(float) * 4;
            [FieldOffset(a3)] public float BucketSoil;         const int a4 = a3 + sizeof(float);
            [FieldOffset(a4)] public float BinSoilRight;       const int a5 = a4 + sizeof(float);
            [FieldOffset(a5)] public float BinSoilLeft;        const int a6 = a5 + sizeof(float);
            [FieldOffset(a6)] public float BinSoilNone;        const int a7 = a6 + sizeof(float);
            [FieldOffset(a7)] public fixed float JoyStick[4];  const int a8 = a7 + sizeof(float) * 4;
            [FieldOffset(a8)] public fixed float Fuel[2];      const int a9 = a8 + sizeof(float) * 4;            
            public const int dl = a9 + sizeof(float);
        };
