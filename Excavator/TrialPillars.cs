...
namespace Excavator
{
    internal partial class TrialPillars : Trial
    {
            ...
            : base(fb)
        {
            ...
            Foundation f = new Foundation(new UserOutput());
            this._Physics = new Physics(f, false);
        ...
        Vector3 AB = new Vector3(Bobcat._V3RotationOffset.X, 0, Bobcat._V3RotationOffset.Z);
        ...
        internal override void drawObjectsNotInShadow()
        {
