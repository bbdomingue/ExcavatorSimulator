...
namespace
{
    ...
    const double PRIME13_PREDIST_FLH  = 1206;
    const double PRIME13_PREDIST_FLV  = 1206;
    const double PRIME13_PREDIST_KC1  = 0.148853;
    const double PRIME13_PREDIST_KC2  = -0.247609;
    const double PRIME13_PREDIST_KC3  = 0.105524;
