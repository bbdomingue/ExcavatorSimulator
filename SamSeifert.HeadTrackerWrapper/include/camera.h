...
namespace CameraLibrary
{
    ...
    public:
        ...
        //== When calling SetFrameRate(), the value is a percentage of the camera's maximum ==---
		...
		virtual bool IsVideoTypeSupported(eVideoMode Mode); //== Query Camera Support =======----

        virtual bool IsVideoTypeSynchronous(eVideoMode Value = CameraLibrary::UnknownMode);
		...
		virtual bool IsHardwareFiltered(eVideoMode Value = CameraLibrary::UnknownMode);
        ...
        bool         SetCompressedBlockingMask(Core::cSerializer &CompressedMask);
        void         GetCompressedBlockingMask(Core::cSerializer &CompressedMask);
        ...
        virtual void FrameSize(eVideoMode Mode, int &Width, int &Height); //== frame size ====---
                                                            //== for given video mode ========---
